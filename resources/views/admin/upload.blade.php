...
@php
    $page = \App\Models\Page::content('upload');
@endphp
...
<meta name="description" content="{{ $page->get('meta_description', 'Upload your Bill of Materials (BOM) and receive consolidated pricing from SimplyTronix.') }}">
...
<meta property="og:description" content="{{ $page->get('meta_description', 'Submit your BOM for fast semiconductor sourcing support.') }}">
...
<meta name="twitter:description" content="{{ $page->get('meta_description', 'Upload your BOM and get fast quote support.') }}">
            ...
            <div class="col text-center">
                <div class="breadcrumb__content text-white py-2">
                    <h1 class="breadcrumb__content--title mb-2" style="color: #fff;">
                        {{ $page->get('hero_title', 'Upload Your BOM') }}
                    </h1>
                    <p class="mb-0" style="color: #fff; font-size: 16px;">
                        {{ $page->get('hero_subtitle', 'Submit your Bill of Materials and receive consolidated pricing fast.') }}
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <div class="account__login">
                            ...
                            <div class="account__login--header mb-25">
                                <h2 class="account__login--header__title mb-10">
                                    {{ $page->get('form_heading', 'Got More Than One Part?') }}
                                </h2>
                                <p class="account__login--header__desc">
                                    {{ $page->get('form_description', 'Upload your complete Bill of Materials and receive consolidated pricing & availability.') }}
                                </p>
                            </div>
