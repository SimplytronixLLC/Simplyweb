...
@section('seo') 
       <title>Our Products - {{$settings->meta_title}}</title> 
        <meta data-rh="true" name="title" content="Our Products -{{$settings->meta_title}}">
        ...
        <meta data-rh="true" property="og:title" content="Our Products -{{$settings->meta_title}}">
        ...
        <meta data-rh="true" name="twitter:title" content="Our Products -{{$settings->meta_title}}">
...
@stop
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-P7JS891KWQ"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-P7JS891KWQ');
</script>
                    ...
                    <div class="col">
                        <div class="breadcrumb__content text-center">
                            <ul class="breadcrumb__content--menu d-flex justify-content-center">
                                ...
                                <li class="breadcrumb__content--menu__items"><span>Our Products</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                @php $i = 1; @endphp
                                    @foreach($listing as $key => $val)     
                                         <div class="row row-border">  
                                            <h3> <a href="{{url('/category')}}/{{ preg_replace('/[^\w\/]/', '-', strtolower($val->Name))}}/{{$val->id}}" class="fs-2" > {{$val->Name}} </a> </h3> 
                                            <ul class="products">
                                               {!! App\Common::get_sub_category($val->CategoryId) !!} 
                                           </ul>
                                        </div>
                                   @php $i++; @endphp
                                 @endforeach 
                ...
                <div class="shipping__inner style2 d-flex justify-content-center">
                    ...
                    <div class="shipping__items style2 d-flex align-items-center">
                        <div class="shipping__icon">  
                            <img src="public/assets/front/img/other/shipping2.webp" alt="icon-img">
                        </div>
                    ...
                    <div class="shipping__items style2 d-flex align-items-center">
                        <div class="shipping__icon">  
                            <img src="public/assets/front/img/other/shipping4.webp" alt="icon-img">
                        </div>
                        <div class="shipping__content">
