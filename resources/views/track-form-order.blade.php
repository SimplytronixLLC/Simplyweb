...
@section('content')
        ...
        <section class="product__details--section pt-5 bg-gray">
            <div class="container ">
                                    ...
                                    <h2 class="small__product--header__title text-center">Enter Your Order ID</h2>
                                          ...
                                          <div class="p-5">
                                            ...
                                            <div class="main checkout__mian">
                                                    <form action="/track-order" method="POST" data-parsley-validate>
                                                    @csrf
                                ...
                                <div class="small__product--inner product__swiper--column1 swiper">
                                    <div class="swiper-wrapper">
                                        <div class="">
                                           ...
                                           <p class="product__details--info__meta--list p-3 mb-1 border-bottom border-2"><strong>Order Id:</strong>  <span>gdgdsf</span> </p>

                                           <p class="product__details--info__meta--list p-3 mb-1 border-bottom border-2"><strong>Name:</strong>  <span>gdgdsf</span> </p>

                                           <p class="product__details--info__meta--list p-3 mb-1 border-bottom border-2"><strong>Email:</strong>  <span>gdgdsf</span> </p>

                                           <p class="product__details--info__meta--list p-3 mb-1 border-bottom border-2"><strong>Phone:</strong>  <span>gdgdsf</span> </p>

                                           <p class="product__details--info__meta--list p-3 mb-1 border-bottom border-2"><strong>Part Number:</strong>  <span>gdgdsf</span> </p>

                                           <p class="product__details--info__meta--list p-3 mb-1 border-bottom border-2"><strong>Quantity:</strong>  <span>gdgdsf</span> </p>
