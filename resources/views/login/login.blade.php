...
@section('seo')	 
    ...
    <title>Login | {{@$settings->meta_title}}</title>

    <meta name="title" content="Login - {{@$settings->meta_title}}">
    ...
    <meta property="og:site_name" content="Login - {{@$settings->meta_title}}" />

    <meta property="og:type" content="article" />

    <meta property="og:title" content="Login - {{@$settings->meta_title}}" />
                ...
                <div class="shipping__inner style2 d-flex justify-content-center">
                    ...
                    <div class="shipping__items style2 d-flex align-items-center">
                        ...
                        <div class="shipping__content">
                            <h2 class="shipping__content--title h4">Support 24/7</h2>
                    ...
                    <div class="shipping__items style2 d-flex align-items-center">
                        ...
                        <div class="shipping__content">
                            <h2 class="shipping__content--title h4">Payment Secure</h2>
