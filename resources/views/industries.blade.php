...
<meta name="description" content="Simplytronix supports OEMs and EMS providers across industrial, automotive, medical, telecom, data center, power, aerospace, and test & measurement industries with reliable electronic component sourcing.">
@stop
...
<section class="ind-hero">
    ...
    <div class="ind-hero-inner">
        ...
        <p>Supporting OEMs, EMS providers, and technology-driven businesses worldwide with reliable electronic component sourcing.</p>
...
<div class="container">
    ...
    {{-- Intro --}}
    <p class="ind-intro">
        At <strong>Simplytronix</strong>, our experience across diverse applications lets us understand industry-specific requirements,
        compliance needs, and supply chain challenges — especially during shortages and constrained markets.
        <br><br>
        <em>We don't just supply components. We help keep production moving.</em>
    </p>

    {{-- Filter bar --}}
    @php
    $industries = [
        ['tag'=>'Manufacturing', 'img'=>'industrial-automation.jfif',    'alt'=>'Industrial Automation',    'title'=>'Industrial & automation',       'desc'=>'Control systems, smart manufacturing, and automation equipment for factory floors worldwide.',              'apps'=>['PLCs and industrial controllers','Sensors and actuators','Power management modules','Embedded control systems'],    'note'=>'<strong>Why it matters:</strong> Reliability, long lifecycle components, and consistent supply are critical in industrial environments.'],
        ['tag'=>'Mobility',      'img'=>'automotive-electronics.jfif',   'alt'=>'Automotive Electronics',   'title'=>'Automotive & transportation',    'desc'=>'Components for modern vehicles, EV powertrains, and Tier 1 & 2 suppliers globally.',                         'apps'=>['Infotainment systems','ADAS and safety electronics','Powertrain electronics','Body control modules'],                'note'=>'<strong>Our focus:</strong> Quality-conscious sourcing while navigating long lead times and obsolescence challenges.'],
        ['tag'=>'Healthcare',    'img'=>'medical-electronics.jfif',      'alt'=>'Medical Electronics',      'title'=>'Medical & healthcare',           'desc'=>'Accuracy, reliability, and compliance-grade components for life-critical medical electronics.',                 'apps'=>['Diagnostic equipment','Patient monitoring systems','Imaging devices','Laboratory instruments'],                      'note'=>'<strong>What we prioritize:</strong> Stable sourcing, traceability, and components suitable for regulated environments.'],
        ['tag'=>'Connectivity',  'img'=>'telecom-networking.jfif',       'alt'=>'Telecommunications',       'title'=>'Telecommunications & networking', 'desc'=>'High-speed, always-on infrastructure components for telecom networks and next-gen connectivity.',             'apps'=>['Network switches and routers','RF and wireless modules','Data transmission systems','Signal integrity solutions'],   'note'=>'<strong>Key value:</strong> Dependable component availability for fast-evolving technologies.'],
        ['tag'=>'Computing',     'img'=>'data-center-computing.jfif',    'alt'=>'Data Centers',             'title'=>'Data centers & computing',       'desc'=>'Enterprise and hyperscale data center computing hardware at any volume, on any timeline.',                    'apps'=>['Servers and storage systems','Power supplies and cooling','High-speed memory and processors','Networking ASICs'],   'note'=>'<strong>Our advantage:</strong> Experience with memory, logic, and hard-to-find parts during demand spikes.'],
        ['tag'=>'Energy',        'img'=>'power-energy.jfif',             'alt'=>'Power and Energy',         'title'=>'Power & energy',                 'desc'=>'From grid infrastructure to renewable energy systems — powering the energy transition worldwide.',             'apps'=>['Power converters and inverters','Energy monitoring systems','Renewable energy controllers','Smart grid hardware'],  'note'=>'<strong>What matters most:</strong> Component durability, efficiency ratings, and supply continuity.'],
        ['tag'=>'Defense',       'img'=>'aerospace-electronics.jfif',    'alt'=>'Aerospace Electronics',    'title'=>'Aerospace & defense',            'desc'=>'Precision sourcing for non-classified aerospace and defense-adjacent manufacturing applications.',              'apps'=>['Avionics support systems','Ground equipment electronics','Test and measurement systems'],                             'note'=>'<strong>Our approach:</strong> Precision sourcing with attention to quality documentation and traceability.'],
        ['tag'=>'Test & Measurement',       'img'=>'test-measurement.jfif',         'alt'=>'Test and Measurement',     'title'=>'Test & measurement',             'desc'=>'Specialized and low-volume components for R&D labs and production test environments worldwide.',               'apps'=>['Oscilloscopes and analyzers','Calibration equipment','Industrial test systems'],                                     'note'=>'<strong>Why customers choose us:</strong> Deep support for specialized and hard-to-source components.'],
    ];
    ...
    {{-- Value strip --}}
    <div class="ind-value">
        <h2>How we add value across industries</h2>
        <div class="ind-value-items">
            <div class="ind-value-item">
                <i class="ti ti-alert-triangle" aria-hidden="true"></i>
                <span>Shortage support</span>
            </div>
            <div class="ind-value-item">
                <i class="ti ti-search" aria-hidden="true"></i>
                <span>EOL & hard-to-find parts</span>
            </div>
            <div class="ind-value-item">
    ...
    {{-- CTA --}}
    <div class="ind-cta">
        <h2>Let's support your industry</h2>
        <p>If your industry isn't listed above, chances are we can still help. Our sourcing expertise extends across a broad range of applications and markets.</p>
